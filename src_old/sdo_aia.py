...
from utils import down_aia_euv
...
file_304 = down_aia_euv(ROOT_RAW, obstime, window, 304)
print(file_304)

plot_304 = ROOT_FIG / f'{obstime_str}_sdo_aia_304.png'
...
plot_304_disk = ROOT_FIG / f'{obstime_str}_sdo_aia_304_disk_prep.png'
plot_304_hg = ROOT_FIG / f'{obstime_str}_sdo_aia_304_hg_prep.png'
...
file_171 = down_aia_euv(ROOT_RAW, obstime, window, 171)
print(file_171)

plot_171 = ROOT_FIG / f'{obstime_str}_sdo_aia_171.png'
...
plot_171_disk = ROOT_FIG / f'{obstime_str}_sdo_aia_171_disk_prep.png'
plot_171_hg = ROOT_FIG / f'{obstime_str}_sdo_aia_171_hg_prep.png'
